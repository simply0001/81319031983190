    ...
    androidx.compose.runtime.CompositionLocalProvider(
        ...
        PocketPassTheme(state.themeMode) {
            ...
            PhoneSurface { metrics ->
                PhoneRoot(metrics, state, viewModel, extensions)
            }
        }
    }
}
...
private fun PhoneRoot(
    ...
    val dispatch: (PocketPassEvent) -> Unit = viewModel::dispatch
    when {
        ...
        state.requiresMiiGate() -> PhoneMiiGate(metrics, state, viewModel)
