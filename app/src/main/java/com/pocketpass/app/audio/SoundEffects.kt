...
enum class SoundEffect(@param:RawRes val resource: Int) {
    Keyboard(R.raw.sfx_keyboard),
    KeyboardBackspace(R.raw.sfx_keyboard_backspace),
    Cancel(R.raw.sfx_cancel),
    TabLeft(R.raw.sfx_tab_left),
    TabRight(R.raw.sfx_tab_right),
    Navigation(R.raw.sfx_navigation),
    Notification(R.raw.sfx_notification),
    MessageSent(R.raw.sfx_message_sent),
    MessageReceived(R.raw.sfx_message_received),
    Confirm(R.raw.sfx_confirm),
}
