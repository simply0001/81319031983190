...
internal fun patternGeometryFor(geometryWidth: Float): PatternGeometry =
    if (geometryWidth > 1_500f) TOP_PATTERN_GEOMETRY else BOTTOM_PATTERN_GEOMETRY

internal fun patternChannels(argb: Int): FloatArray = floatArrayOf(
    ((argb shr 16) and 0xFF) / 255f,
    ((argb shr 8) and 0xFF) / 255f,
    (argb and 0xFF) / 255f,
)

internal fun patternAlpha(argb: Int): Float = ((argb shr 24) and 0xFF) / 255f

internal fun isDarkPatternBackdrop(topColor: Color, bottomColor: Color): Boolean {
